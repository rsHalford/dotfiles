...
JetBrains Mono, Lexend and Gelasio is all I need.
...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq org-capture-templates
    '(("t" "Tasks")
      ...
      ("m" "Metrics Capture")
      ("mw" "Body Weight" table-line (file+headline "~/Documents/Agenda/Metrics.org" "Body Weight")
...
Create custom search queries to be used within keybonds or notifications, etc.
