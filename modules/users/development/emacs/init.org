...
Too much of a fuss to setup calendar with radicale.
...
Sync Org agenda file with calendar server.
...
#+begin_src emacs-lisp :tangle no
  ...
  (use-package org-caldav
    :defer t
    :init
    (setq org-caldav-url "https://calendar.xhalford.com/radicale/richard/"
          org-caldav-calendars
          '(( :calendar-id "bf4bc876-848a-0daa-8794-e085a0e34b8c"
              :files ("~/Documents/Agenda/Calendar.org")
              :inbox "~/Documents/Agenda/FromCalendar.org"))
