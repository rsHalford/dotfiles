...
Sync Org agenda file with Google Calendar.
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package org-gcal
    :after org
    :config
    (setq org-gcal-client-id (password-store-get "Calendar/richardh.1995@googlemail.com/ID")
          org-gcal-client-secret (password-store-get "Calendar/richardh.1995@googlemail.com/Secret")
          org-gcal-fetch-file-alist `(("richardh.1995@googlemail.com" . "~/Documents/Agenda/Calendar.org"))))
